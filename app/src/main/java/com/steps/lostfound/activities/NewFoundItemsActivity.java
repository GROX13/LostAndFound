...
public class NewFoundItemsActivity extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDateEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                newFragment.setOnDateSetListener(NewFoundItemsActivity.this);
        ...
        mPickPlace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(NewFoundItemsActivity.this, MapActivity.class);
    ...
    private boolean validateFields() {
        ...
        if (mRadius < 0) {
            isValid = false;
            mPickPlace.setError(getString(R.string.pick_place));
        }
        if (mDate == null) {
            isValid = false;
            mDateEditText.setError(getString(R.string.pick_date));
        }
        if (!mCategorySpinner.isSelected()) {
            isValid = false;
        }
