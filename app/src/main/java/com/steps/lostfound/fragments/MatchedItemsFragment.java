...
public class MatchedItemsFragment extends Fragment {
    ...
    private ParseQueryAdapter<Item> matchedItemsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_matched_items, container, false);
        ...
        matchedItemsAdapter = new MatchedItemsAdapter(getActivity(), factory);
        ListView itemsListView = (ListView) v.findViewById(R.id.items_list_view);
        itemsListView.setAdapter(matchedItemsAdapter);
